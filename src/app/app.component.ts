...
import {Masonry, MasonryGridItem, NgMasonryGridComponent, NgMasonryGridModule} from 'ng-masonry-grid';
...
export class AppComponent implements NgMasonryGridModule{
  title = 'app';
  masonryItems = [
    '1',
    '1',
