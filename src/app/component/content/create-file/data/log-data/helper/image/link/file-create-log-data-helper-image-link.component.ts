...
@Component({
  ...
  templateUrl: './file-create-log-data-helper-image-link.component.html',
  styleUrls: ['./file-create-log-data-helper-image-link.component.css']
})
export class FileCreateLogDataHelperImageLinkComponent implements AfterViewInit {
