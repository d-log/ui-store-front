...
@Component({
  ...
  templateUrl: './file-create-log-data-helper-image-existing.component.html',
  styleUrls: ['./file-create-log-data-helper-image-existing.component.css']
})
export class FileCreateLogDataHelperImageExistingComponent implements OnInit {
